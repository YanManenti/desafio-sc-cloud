...
Os códigos em Python nos arquivos Primo.py e Fibonacci.py.

Para executar o código:

1. Tenha certeza que o seu computador tem Python instalado.
1. Pelo cmd navegue até a pasta principal baixada.
1. Execute `python main.py`
1. Siga as instruções na tela para testar tanto as funções lineares quanto as recursivas.
